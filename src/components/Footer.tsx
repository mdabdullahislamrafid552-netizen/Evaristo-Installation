...
export default function Footer() {
  return (
    <footer className="bg-brand-blue text-stone-300 py-20 px-6 md:px-12">
      ...
      <div className="max-w-[1400px] mx-auto pt-8 border-t border-brand-blue/50 text-xs flex flex-col md:flex-row justify-between items-center gap-4">
